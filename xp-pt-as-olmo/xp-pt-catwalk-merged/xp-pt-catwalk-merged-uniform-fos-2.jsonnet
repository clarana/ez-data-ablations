...
local models = [
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-Education-110m",
        gpus_needed: 1,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-Engineering-110m",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-EnvironmentalScience-110m",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-MaterialsScience-110m",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-Mathematics-110m",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-Medicine-110m",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
