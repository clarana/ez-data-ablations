...
local gsheet = "uniform-merged-fos-1"; //"my-new-gsheet-CHANGE-ME";

// Models to evaluate

local models = [
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-AgriculturalAndFoodSciences-110m",
        gpus_needed: 1,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-Biology-110m",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-Business-110m",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-Chemistry-110m",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-ComputerScience-110m",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-Economics-110m",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
