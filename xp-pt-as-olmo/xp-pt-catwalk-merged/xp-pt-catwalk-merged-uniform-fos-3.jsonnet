...
local models = [
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-NA-110m",
        gpus_needed: 1,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-Physics-110m",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-PoliticalScience-110m",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-Psychology-110m",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
