...
// Set it to null if you do not want your results to be uploaded to a google sheet (they will still be saved as an object).
 local gsheet = "uniform-merged-combo"; //"my-new-gsheet-CHANGE-ME";

// Models to evaluate

local models = [
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-fos-22-110m",
        gpus_needed: 1,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/merged-fos-decon-110m/merged-128-110m",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
