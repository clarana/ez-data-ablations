...
local models = [
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/branched-train-EnvironmentalScience1970-2013-v2",
        gpus_needed: 1,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/branched-train-EnvironmentalScience2014-2016-v2",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/branched-train-EnvironmentalScience2017-2018-v2",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/branched-train-EnvironmentalScience2019-2019-v2",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/branched-train-EnvironmentalScience2020-2020-v2",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/branched-train-EnvironmentalScience2021-2021-v2",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
    ...
    {
        model_path: "/net/nfs.cirrascale/allennlp/claran/catwalk-models/branched-train-EnvironmentalScience2022-2022-v2",
        gpus_needed: 1,
        trust_remote_code: true,
        prediction_kwargs: {
            model_max_length: 2048,
