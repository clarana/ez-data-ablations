...
cp -r /net/nfs.cirrascale/allennlp/claran/model-dumps/1b-i${IND}/branch-xppt-data_mix_2fos_upsamp/ /results

wandb login --relogin $WANDB_KEY

export EXPT_BASE=data_mix_2fos_upsamp
export SOURCE=s2orc-recombined

export EXPT=${EXPT_BASE}-part-$SOURCE-i${IND}-${FOS1//[, ]/}-${FOS2//[, ]/}
...
export CHECKPOINT_FOLDER=/results/branch-xppt-${EXPT_BASE}/${SOURCE}/${EXPT_BASE}-part-$SOURCE-i${IND}-${FOS1//[, ]/}-${FOS2//[, ]/}
...
python xp-pt-as-olmo/convert_checkpoint.py --checkpoint $checkpt --config xp-pt-as-olmo/configs/customgpt-${MODEL_SZ}.yaml --output_dir /net/nfs.cirrascale/allennlp/claran/catwalk-models/data-mix-upsamp-s2orc-$MODEL_SZ/seq-2fos-i${IND}-${FOS1//[, ]/}-${FOS2//[, ]/}
cp /net/nfs.cirrascale/allennlp/claran/catwalk-models/seed-decon-5epoch-${MODEL_SZ}/*.json /net/nfs.cirrascale/allennlp/claran/catwalk-models/data-mix-upsamp-s2orc-$MODEL_SZ/seq-2fos-i${IND}-${FOS1//[, ]/}-${FOS2//[, ]/}
