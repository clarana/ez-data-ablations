...
export EXPT_BASE=data_mix_2_no_resamp
...
export HF_HOME=/net/nfs.cirrascale/allennlp/claran/hf_datasets
...
python xp-pt-as-olmo/convert_checkpoint.py --checkpoint $checkpt --config xp-pt-as-olmo/configs/customgpt-110m.yaml --output_dir /net/nfs.cirrascale/allennlp/claran/catwalk-models/data-mix-no-resamp-prelim/branch-train-2-i${IND}-${PART1//[, ]/}-${PART2//[, ]/}
cp /net/nfs.cirrascale/allennlp/claran/catwalk-models/seed-xppt/*.json /net/nfs.cirrascale/allennlp/claran/catwalk-models/data-mix-no-resamp-prelim/branch-train-2-i${IND}-${PART1//[, ]/}-${PART2//[, ]/}
