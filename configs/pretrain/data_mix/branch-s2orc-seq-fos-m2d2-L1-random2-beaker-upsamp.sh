...
export EXPT_BASE=data_mix_fos_L1_upsamp-updated
#function join_by { local IFS="$1"; shift; echo "$*"; }
#export SOURCES=("s2orc-recombined" "m2d2_wiki-toplevel")

export EXPT=${EXPT_BASE}-i${IND}-${FOS1//[, ]/}-${L1}-${NUM_BIL_TOKS}bil
...
python xp-pt-as-olmo/convert_checkpoint.py --checkpoint $checkpt --config xp-pt-as-olmo/configs/customgpt-${MODEL_SZ}.yaml --output_dir /net/nfs.cirrascale/allennlp/claran/catwalk-models/data-mix-upsamp-s2orc-wiki-$MODEL_SZ-updated/seq-fos-L1-i${IND}-${FOS1//[, ]/}-${L1//[, ]/}
cp /net/nfs.cirrascale/allennlp/claran/catwalk-models/seed-decon-5epoch-${MODEL_SZ}/*.json /net/nfs.cirrascale/allennlp/claran/catwalk-models/data-mix-upsamp-s2orc-wiki-$MODEL_SZ-updated/seq-fos-L1-i${IND}-${FOS1//[, ]/}-${L1//[, ]/}
