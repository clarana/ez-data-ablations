...
export CHECKPOINT_FOLDER=/data/claran/branch-xppt-${EXPT_BASE}/${SOURCE}/$EXPT
...
#cp "$CHECKPOINT_FOLDER/$EXPT-metrics.json" $CHECKPOINT_FOLDER/metrics.json
#
...
#cp /net/nfs.cirrascale/allennlp/claran/catwalk-models/seed-decon-5epoch-${MODEL_SZ}/*.json /net/nfs.cirrascale/allennlp/claran/catwalk-models/data-mix-upsamp-s2orc-fixwiki-$MODEL_SZ/seq-fos-fixwiki-i${IND}-${FOS1//[, ]/}-${L1}
