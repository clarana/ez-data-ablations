...
cp -r /net/nfs.cirrascale/allennlp/claran/model-dumps/seed-300m/seed-xppt-5epoch-decon-paloma-seed-300m/ /results
...
export EXPT=${NUM_EPOCH}epoch-decon-paloma-seed-300m
...
export HF_HOME=/net/nfs.cirrascale/claran/hf_datasets
