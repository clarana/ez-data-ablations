...
export CHECKPOINT_FOLDER=/results/branch-xppt-${EXPT_BASE}/${SOURCE}/${FOS}-i${SUB_IND}-of${NUM_SUBSETS}
...
python xp-pt-as-olmo/convert_checkpoint.py --checkpoint $checkpt --config xp-pt-as-olmo/configs/customgpt-110m.yaml --output_dir /net/nfs.cirrascale/allennlp/claran/catwalk-models/subbranch-train-fos-${FOS}-i${SUB_IND}-of${NUM_SUBSETS}
cp /net/nfs.cirrascale/allennlp/claran/catwalk-models/seed-xppt/*.json /net/nfs.cirrascale/allennlp/claran/catwalk-models/subbranch-train-fos-${FOS}-i${SUB_IND}-of${NUM_SUBSETS}
