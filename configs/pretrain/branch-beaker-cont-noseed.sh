...
export SOURCE=$5
export SOURCE_INFO=$6
# other things are hardcoded so only supports m2d2_wiki or m2d2_wiki-toplevel
...
export PARTITION_INFO=/net/nfs.cirrascale/allennlp/claran/${SOURCE_INFO}
