...
export EXPT_BASE=seed40bil-seq-L1-upsamp-decon-$MODEL_SZ
export SOURCE=m2d2_wiki-toplevel
export EXPT=${EXPT_BASE}-part-$SOURCE-${TOPIC//[, ]/}
...
export CHECKPOINT_FOLDER=/results/xppt-${EXPT_BASE}/${SOURCE}/${TOPIC}
...
python xp-pt-as-olmo/convert_checkpoint.py --checkpoint $checkpt --config xp-pt-as-olmo/configs/customgpt-${MODEL_SZ}.yaml --output_dir /net/nfs.cirrascale/allennlp/claran/catwalk-models/seq-L1-decon-$MODEL_SZ/seq-L1-$TOPIC-upsamp
cp /net/nfs.cirrascale/allennlp/claran/catwalk-models/seed-decon-5epoch-${MODEL_SZ}/*.json /net/nfs.cirrascale/allennlp/claran/catwalk-models/seq-L1-decon-$MODEL_SZ/seq-L1-$TOPIC-upsamp
