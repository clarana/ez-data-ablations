...
cp -r /net/nfs.cirrascale/allennlp/claran/model-dumps/seed-1_1b/seed-xppt-5epoch-decon-paloma-seed-1_1b/ /results
...
export EXPT=${NUM_EPOCH}epoch-decon-paloma-seed-1_1b
...
export checkpt=$(find $CHECKPOINT_FOLDER | grep customgpt-1_1b-tokens)
echo "$checkpt"
...
python xp-pt-as-olmo/convert_checkpoint.py --checkpoint $checkpt --config xp-pt-as-olmo/configs/customgpt-1_1b.yaml --output_dir /net/nfs.cirrascale/allennlp/claran/catwalk-models/seed-1_1b-decon-${NUM_EPOCH}epoch
cp /net/nfs.cirrascale/allennlp/claran/catwalk-models/seed-xppt/*.json /net/nfs.cirrascale/allennlp/claran/catwalk-models/seed-1_1b-decon-${NUM_EPOCH}epoch
